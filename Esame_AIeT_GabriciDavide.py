...
colonneI = np.linspace(-2, 1, num = 21)  # 11 colonne, quindi 12 estremi
...
# costruzione delle colonne
colonneII = np.linspace(-2, 1, num = 21)  # 16 colonne, quindi 17 estremi
...
# costruzione delle colonne
colonneIII = np.linspace(-2, 1, num = 21)  # 7 colonne, quindi 8 estremi
